let crearGrafica1 = (myData) => {
    ...
    for (let i = 0; i < myData.estadistica.ventasMes.valores.length; i++) {
        columns[i] = [];
        color[i] = [];
        columns[i].push(myData.estadistica.ventasMes.valores[i][0], myData.estadistica.ventasMes.valores[i][1]);
        color[i].push(myData.estadistica.ventasMes.valores[i][2]);
    }
    console.log(myData.estadistica.ventasMes.valores);
    console.log(columns);
    ...
    let labels = myData.estadistica.estadisticasGanancias.labels;
    let series = myData.estadistica.estadisticasGanancias.series;
    ...
    labels = myData.estadistica.serviciosRealizados.labels;
    series = myData.estadistica.serviciosRealizados.series;
