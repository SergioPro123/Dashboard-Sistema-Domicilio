...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-10-2020 a las 20:27:48
...
--
ALTER TABLE `encargados`
  MODIFY `id_encargados` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `mydate`
  MODIFY `id_date` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `servicios`
  MODIFY `id_servicios` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
