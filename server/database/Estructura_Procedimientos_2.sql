...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-10-2020 a las 04:18:40
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `aceptarServicio` (IN `idDomiciliarioVariable` INT(11), IN `idServicioVariables` INT)  NO SQL
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `addEvidencia` (IN `id_ServiciosVariable` INT(15), IN `path_evidenciaVariable` VARCHAR(255), OUT `idEvidenciaVariable` INT(15))  NO SQL
BEGIN

INSERT INTO evidencia(evidencia.path_evidencia,evidencia.id_servicios)
			VALUES(path_evidenciaVariable,id_ServiciosVariable);
   SELECT LAST_INSERT_ID() into idEvidenciaVariable;
...
INSERT INTO `servicios` (`id_servicios`, `id_cliente`, `id_encargados`, `id_direcciones`, `id_tipoServicios`, `id_date`, `id_estadoServicio`, `descripcion`, `adicional`, `id_evidencia`) VALUES
(3, 4, 21, 6, 2, 12, 2, 'Esto es una prueba', 5200, NULL),
(4, 4, 22, 6, 2, 12, 1, 'Esto es una prueba', 5200, NULL);
...
--
ALTER TABLE `credenciales`
  MODIFY `id_credenciales` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT de la tabla `datospersonales`
--
ALTER TABLE `datospersonales`
  MODIFY `id_datosPersonales` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `mydate`
  MODIFY `id_date` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
